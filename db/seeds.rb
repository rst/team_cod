...
<br>
<a href='https://jobs.kfc.com/job/dorchester/kfc-team-member/1672/148210' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
<br>
<a href='https://jobs.kfc.com/job/dorchester/kfc-restaurant-general-manager/1672/144586' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
<Br>
<a href='https://jobs.kfc.com/job/dorchester/kfc-assistant-restaurant-manager/1672/147712' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
<a href='https://jobs.kfc.com/job/dorchester/kfc-shift-supervisor/1672/149683' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
office_max_sales_consultant = Event.create!({name: "Office Max Sales Consultant", description: "
<br>
<a href='http://jobs.officedepot.com/job/5234296/retail-sales-consultant-dorchester-ma/' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
<a href='https://wfa.kronostm.com/index.jsp?INDEX=0&LOCATION_ID=24197625066&locale=en_US&applicationName=StarbucksNonReqExt&EVENT=com.deploy.application.hourly.plugin.SelectAdditionalLocations.doSearch&SEQ=selectAdditionalLocations&POSTING_ID=667441924' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
bed_bath_and_beyond_manager = Event.create!({name: "Bed Bath And Beyond Manager", description: "
<br\>
<a href='https://www.hrapply.com/bbb/AppJobView.jsp?link=6323&page=AppJobList.jsp&skimSessionName=com.hrlogix.view.cont.table.cs.req.JobListTable&skimName=requisition.requisition_id&skimNdx=13&op=reset' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
<br\>
<a href='https://career8.successfactors.com/career?career_ns=job_listing&company=TJX&navBarLevel=JOB_SEARCH&rcm_site_locale=en_US&career_job_req_id=63701&selected_lang=en_US&jobAlertController_jobAlertId=&jobAlertController_jobAlertName=&_s.crb=jeMRIIQjJoUmj5pyJzqgKFPdhMU%3d' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
...
amc_film_crew = Event.create!({name: "AMC Film Crew", description: "
<br\>
<a href='https://sjobs.brassring.com/TGWebHost/jobdetails.aspx?SID=%5eRvnLQlU9TYFUGWjpWNbhUQby8tRIOIDB2R42o9PuXXH50PGFzQkuNTZQpBvcdKRn&jobId=351692&type=search&JobReqLang=1&recordstart=1&JobSiteId=5197&JobSiteInfo=351692_5197&GQId=795' class='btn btn-primary btn-lg'>Click here to apply!</a>
"}) # no req, full time
